/*****************************************************************************
                           allreduceButterfly.cpp  -  description
                             -------------------
    begin                : October 2019
...
inline std::vector<gaspi_rank_t> allreduceButterfly::getRanks() const {
...
void allreduceButterfly::wait() {
  ...
  while(operator()());
  gaspiCheckReturn(gaspi_barrier(group, GASPI_BLOCK),
                   "barrier failed with ");
}
